...
document.addEventListener("DOMContentLoaded", () => {
    ...
    <div id="ai-chat-box">
      ...
      <div id="ai-messages">
        <div class="ai-msg welcome">
          <h3>👋 Welcome</h3>
          <p>I'm <b>Harsh AI</b>, the official virtual assistant of <b>Harsh Panchal</b>.</p>
  ...
  async function sendMessage() {
    ...
    try {
      ...
      removeTyping();
      console.error(error);
      addAIMessage("⚠️ Sorry, I'm unable to connect right now. Please try again in a few seconds.");
    }
  }
  ...
  window.addEventListener("load", () => {
    setTimeout(() => {
      speak("Hello! I'm Harsh AI. How can I help you today?");
    }, 600);
  });
